...
class HGSRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        # Fix: Match dimension handling from NaiveRewardManager
        responses = data.batch['responses']
        if responses.dim() == 1:  # Add batch dimension if needed
        ...
        if return_dict:
            return {'reward_tensor': reward_tensor, 'reward_extra_info': extra_info_dict}
        else:
