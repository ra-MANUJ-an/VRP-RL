...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/neuralcombinatorialoptimization/rl_llm_metaheuristics/processed_tsp_100_data/train.parquet \
    data.val_files=$HOME/neuralcombinatorialoptimization/rl_llm_metaheuristics/processed_tsp_100_data/test.parquet \
    ...
    trainer.experiment_name='Qwen-2.5-0.5B-Instruct' \
